...
| 18. sept (kveld) | **Full SEO-gjennomgang av alt som lar seg måle.** Hovedfunn: **topp 3 gir 8,2 % klikkrate, plass 4–10 gir 1,3 %** — topp 3 er 6 % av visningene og 43 % av klikkene, så å flytte en side fra plass 11 til 9 er nær verdiløst. Enhetssplitt-forklaringen testet og forkastet (mobil og datamaskin ligger likt). **Produsentmalen målt:** 29 sider med mal 3,57 % mot 131 uten 2,15 %, og 23 organiske sesjoner per side mot 2,6 på kategorisider. **Verktøyvogner faller** — «verktøyvogn» plass 13 → 26 på ett år, eneste kjernekategori som taper terreng. 20 sider gir 29 411 visninger og 83 klikk. 4 308 sider med visninger ligger utenfor sitemap (45 % av klikkene). Bing kjenner 126 av 8 856 sider. AI Assistant er ny egen GA4-kanal, 187 sesjoner med høyest andel nøkkelhendelser. Rapport: `~/Desktop/FT-analyse-18sept/hovedrapport.html`. Memory: `project_seo_topp3_eller_ingenting`, `project_produsentmal_virker`, `project_verktoyvogner_faller`. |
