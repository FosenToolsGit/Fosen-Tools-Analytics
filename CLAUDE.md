...
### Åpent
- **Kofferter: 32 av 66 caser fanges ikke av noen størrelseschip**, fordi dataene bruker både `mellom`/`stor` og `medium`/`store`. Uavklart om det er bevisst.
