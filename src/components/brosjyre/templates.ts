  ...
  // ------------------------------- BRANSJE -------------------------------
  {
    ...
    build: (idx: number): Page => {
      ...
      p.objects = [
        ...
        txt(15, 70, 110, 18, "Sertifisert leverandør til forsvarsindustrien. Pelicase, Snap-on og Stahlwille med Fosen Tools-standarden.", "h5", { color: "rgba(255,255,255,0.7)", weight: 400 }),
  ...
  // ------------------------------- BAKSIDE -------------------------------
  {
    ...
    build: (idx: number): Page => {
      ...
      p.objects = [
        ...
        txt(15, 192, 180, 8, "Man – fre   07:00 – 15:00", "h3", { color: "#fff" }),
