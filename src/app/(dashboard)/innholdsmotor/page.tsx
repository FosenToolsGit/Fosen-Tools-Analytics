  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <Card className="p-6 space-y-3">
        <h3 className="font-semibold text-white text-sm">Slik virker det</h3>
        <ol className="text-xs text-gray-400 space-y-2 list-decimal list-inside">
          <li>Velg URL eller skriv inn topic manuelt</li>
          <li>Velg topic-type + archetype (visuell stil)</li>
          <li>Klikk Generér — Gemini lager caption + evt. AI-bilde</li>
          <li>Draft havner i Kø-tab</li>
          <li>Godkjenn, rediger eller avvis</li>
          <li>Avvisninger/edits forbedrer fremtidige prompts (live feedback-loop)</li>
        </ol>
        <div className="pt-3 border-t border-gray-800">
          <p className="text-xs text-amber-300/80">
            <strong>Husk:</strong> archetype <code>foto</code> bruker ekte bilder. Andre archetypes
            (definisjon, statement, kontrast, milepael, sitat, sertifikat) lager AI-bilde via Imagen.
            FT-doktrinen forbyr AI-genererte HDFI/produkter — bruk <code>foto</code> for leveranser.
          </p>
        </div>
      </Card>
    </div>
